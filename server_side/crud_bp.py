...
def record_workout():
    ...
    for inputID, vals in req.items():
        ...
        if drill == "CARs":
            ...
            ifCARs(mover_dict, bout_array, ref_joint_name_string,
                   duration, rpe, external_load, bout_dict_maker)
            # experiments in REFACTORING ???? for RKB
...
def ifCARs(mover_dict, bout_array, ref_joint_name_string, duration, rpe, external_load, bout_dict_maker):
    print("Running CARs...")
    print(ref_joint_name_string)
